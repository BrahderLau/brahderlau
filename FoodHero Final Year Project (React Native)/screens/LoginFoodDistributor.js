...
// Program Name :LoginFoodDistributor.js
// Description :To create the login screen for food distributor
...
export default function LoginFoodDistributor({ navigation }) {
  ...
  async function handleOnLogin(values) {
    ...
    try {
      ...
      navigation.navigate("AppFoodDistributor", { screen: 'HomeFoodDistributor'})
    } catch (error) {
