...
// Program Name :SignUpFoodDistributor.js
// Description :To create the sign up page for food distributor
        ...
        .then(() => {
          Alert.alert(
            ...
            [
              {
                text: 'OK',
                onPress: () => navigation.navigate("AppFoodDistributor", { screen: 'HomeFoodDistributor'})
              }
            ]
          )
        });
              ...
              <Block flex>
                <Block flex={0.17} middle>
                  <Text color="#8898AA" size={20}>
                    Food Distributor Registration Form
                  </Text>
                </Block>
                <Block flex center>
                  <ScrollView
