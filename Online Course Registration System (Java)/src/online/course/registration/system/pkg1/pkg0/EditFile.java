...
public class EditFile {
    ...
    public void changeALineInATextFile(String fileName, String newLine, String str1) {
        String content = new String();
        String editedContent = new String();
        content = readFile(fileName);
        editedContent = editLineInContent(content, newLine, getLineNumber(fileName,str1)); 
    ...
    private int getLineNumber(String Filename,String str1){
        int lineNumber = 0;
        try{
